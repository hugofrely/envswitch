...
main() {
    ...
    echo ""
    echo "Next steps:"
    echo -e "  1. Initialize: ${GREEN}$BINARY_NAME init${NC}"
    echo -e "  2. Create env:  ${GREEN}$BINARY_NAME create work --from-current${NC}"
    echo -e "  3. Install shell integration: ${GREEN}$BINARY_NAME shell install bash${NC}"
    echo ""
